...
* DocXMLConverter.h
*
* Module to return documentation for nodes formatted for DocXML
* ----------------------------------------------------------------------------- */

#ifndef DOCXMLCONVERTER_H_
#define DOCXMLCONVERTER_H_

#include "DoxygenTranslator.h"
#include <map>

/*
* A class to translate doxygen comments into DocXML style comments.
*/
class DocXMLConverter : public DoxygenTranslator {
public:
    DocXMLConverter(bool debugTranslator = false, bool debugParser = false);
    String *makeDocumentation(Node *node);

protected:
    /*
    * Used to properly format DocXML-style command
    */
    ...
    */
    typedef void (DocXMLConverter::*tagHandler)(DoxygenEntity &tag,
    ...
    */
    ...
    /*
    * Print extended DocXML command, like {@code ...} or {@literal ...}
    * arg - command name
    */
